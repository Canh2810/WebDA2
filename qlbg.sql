...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 30, 2019 lúc 11:25 AM
...
(7, 'Võ Đức Cảnh', '1999-10-28', 'Nam', 'duccanh@gmail.com', '123456'),
(8, 'Trần Trung Hiếu', '2000-10-26', 'Nam', 'trunghieu@gmail.com', '123456');
...
(1, '1', 'Active', '2019-11-27 10:07:31', '4390'),
(2, '2', 'Active', '2019-11-07 00:28:03', '650'),
(3, '1', 'Success', '2019-12-30 09:03:53', '3584.8'),
(4, '2', 'Success', '2019-12-30 09:06:47', '3096');
...
(3, 'Võ Đức Cảnh', 'Nam', '1999-10-28', 'duccanh@gmail.com', 'Ngũ Hành Sơn, Đà Nẵng', '0327714235'),
(4, 'Trần Trung Hiếu', 'Nam', '2000-10-26', 'trunghieu@gmail.com', 'Ngũ Hành Sơn, Đà Nẵng', '64565434');
...
--
ALTER TABLE `khachhang`
  MODIFY `idkhachhang` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
